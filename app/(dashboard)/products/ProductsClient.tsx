...
export default function ProductsClient({ products }: { products: ProductRow[] }) {
  ...
  const sorted = [...products]
    ...
    .sort((a, b) => {
      ...
      return b.sold_count - a.sold_count; // הנמכרים ביותר
    });
            ...
            <div className="p-4 text-right">
              ...
              <div className="flex items-center justify-end gap-1 mb-4">
                <span className={`text-xs font-medium ${
                  ...
                  product.stock <= 5          ? "text-orange-500" : "text-emerald-600"
                }`}>
                  {product.stock === 0 ? "אזל מהמלאי" : product.stock <= 5 ? `נותרה יחידה ${product.stock} בלבד` : `${product.stock} במלאי`}
                </span>
